...
var DeviceList = (_temp = _class = function (_EventEmitter) {
    ...
    _createClass(DeviceList, [{
        ...
        key: 'getSession',
        value: function getSession(path, debug) {
            if (debug) {
        ...
        value: function _initStream(transport) {
            ...
            stream.updateEvent.on(function (diff) {
                ...
                var events = [{
                    ...
                    e: _this6.debugChangedSessionsEvent
                }, {
                    d: diff.debugAcquired,
                    e: _this6.debugAcquiredEvent
                }, {
                    d: diff.debugReleased,
                    e: _this6.debugReleasedEvent
                }];
