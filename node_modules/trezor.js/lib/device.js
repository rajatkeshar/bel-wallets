...
var Device = function (_EventEmitter) {
    ...
    function Device(transport, descriptor, features, deviceList, hasDebugLink) {
        ...
        _this.integrityCheckingXpubNetwork = _hdnode.BITCOIN_COIN_INFO;
        ...
        _this.features = _extends({}, features, _this.getVersions(major_version, minor_version, patch_version, bootloader_mode));
        _this.connected = true;

        _this.hasDebugLink = hasDebugLink;
    ...
    _createClass(Device, [{
        ...
        key: 'getVersions',
        value: function getVersions(major_version, minor_version, patch_version, isBootloader) {
            var result = {};
            if (isBootloader) {
                result = {
        ...
        value: function run(fn, options) {
            ...
            var debugLink = !!options_.debugLink;
            var skipFinalReload = !!options_.skipFinalReload || debugLink;
            ...
            var currentSession = this.deviceList.getSession(this.originalDescriptor.path, debugLink);
            ...
            return waitingPromise.then(function (resolvedSession) {
                ...
                var res = Device._run(function (session, features) {
                    ...
                    if (debugLink) {
                        _this2.currentDebugSessionObject = session;
                    } else {
                        _this2.currentSessionObject = session;
                    }
                }, function (error) {
                    if (debugLink) {
                        _this2.currentDebugSessionObject = null;
                    } else {
                ...
                return promiseFinally(Promise.all([promiseFinally(res, function (ok, err) {
                    ...
                    if (error.message === WRONG_PREVIOUS_SESSION_ERROR_MESSAGE && waiting) {
                        // trying again!!!
                        return _this2._waitForNullSession(debugLink).then(function () {
        ...
        key: 'canSayXpub',
        value: function canSayXpub(oldFeatures) {
            ...
            var passphraseDisabled = this.features.passphrase_protection === false && oldFeatures.passphrase_protection === false && this.integrityCheckingPassphrase == null;
            var passphraseEnabledRemembered = this.features.passphrase_protection === true && oldFeatures.passphrase_protection === true && this.rememberedPlaintextPasshprase != null && this.rememberedPlaintextPasshprase === this.integrityCheckingPassphrase;
            var samePasshprase = passphraseDisabled || passphraseEnabledRemembered;
        ...
        value: function _waitForNullSession(debugLink) {
            var _this6 = this;

            return new Promise(function (resolve, reject) {
                var _onDisconnect = function onDisconnect() {};
                var onUpdate = function onUpdate() {
                    var updatedSession = _this6.deviceList.getSession(_this6.originalDescriptor.path, debugLink);
        ...
        value: function isUsed() {
            var session = this.deviceList.getSession(this.originalDescriptor.path, false);
            return session != null;
        }
    }, {
        key: 'isUsedHere',
        ...
        key: '_run',
        value: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(fn, transport, descriptor, deviceList, onAcquire, onRelease, device, debugLink) {
                ...
                return _regenerator2.default.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                _context3.next = 2;
                                return Device._acquire(transport, descriptor, deviceList, onAcquire, device, debugLink);
                            ...
                            case 13:
                                _features = _context3.sent.message;
                ...
                }, _callee3, this, [[3,, 19, 23]]);
            }));

            function _run(_x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13) {
        ...
        key: '_acquire',
        value: function _acquire(transport, descriptor, deviceList, onAcquire, device, debugLink) {
            return (0, _connectionLock.lock)(function () {
                return transport.acquire({
                    path: descriptor.path,
                    previous: descriptor.session
                }, debugLink).then(function (res) {
                    deviceList.setHard(descriptor.path, res, debugLink);
                    return res;
                });
            }).then(function (result) {
                var session = new _session2.default(transport, result, descriptor, !!deviceList.options.debugInfo, device, deviceList.xpubDerive, debugLink);
                if (onAcquire != null) {
                    onAcquire(session);
                }
                return session;
